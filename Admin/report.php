						...
						<div class="col-lg-12">
							  <div class="form-panel">
										...
										<div class="alert alert-info" id="">
											...
											<form action="crreport.php" method="post">
												<div class="btn-group btn-group-justified">
												  <div class="btn-group">
													<label class="" >From</label>
													<input type="date" class="form-control round-form" name="formd" id="from" placeholder="Access-ID" onkeypress='return event.charCode >= 48 && event.charCode <= 57' required><br>
												  </div>
												  <div class="btn-group">
													<label class="" >To</label>
													<input type="date" class="form-control round-form" name="tod" id="To" placeholder="Member id" onkeypress='return event.charCode >= 48 && event.charCode <= 57' min="<?php  ?>" max="<?php echo $crdate; ?>" required><br>
												  </div>
												  
												</div>
												<div class="btn-group btn-group-justified">
													<div class="btn-group">
														<button class="btn btn-primary btn-lg btn-block" type="submit" onclick="" value="Report">Report </button>
													</div>	
													<div class="btn-group">
														<a class="btn btn-primary btn-lg btn-block" href="crreport.php" >Current Report</a>
													</div>
												</div>
											</form>
