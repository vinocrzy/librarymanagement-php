<?php
	...
	$selectedMemberId = $_REQUEST['selectedsMemberId'];

	$query = mysqli_query($db,"SELECT * From members Where Id = '$selectedMemberId'");
...
<html>
	...
	<div class="white-header">
								...
								<p><b><?php echo ucfirst($result['FirstName']); ?>[<?php echo $selectedMemberId; ?>]</b></p>
									<div class="row">
										<div class="col-md-6">
											<p class="mt">Year</p>
											<p><?php echo ucfirst($result['year']); ?></p>
										</div>
										<div class="col-md-6">
