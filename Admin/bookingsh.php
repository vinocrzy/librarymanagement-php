...
//Include pagination class file
    ...
    //get number of rows
    $queryNum = $db->query("SELECT COUNT(*) as bookId FROM booking INNER JOIN books ON books.bookId=booking.bookId WHERE booking.memberId like '%".$q."%'");
    ...
    //get rows
    $query = $db->query("SELECT * FROM booking INNER JOIN books ON books.bookId=booking.bookId WHERE booking.memberId like '%".$q."%'");
