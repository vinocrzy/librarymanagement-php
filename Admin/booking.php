...
<html lang="en">
  <head>
	...
	<script>
			...
			function ibooking(str) {
				var str1 = document.getElementById("ism").value;
				if (str == "") {
					document.getElementById("vwbook").innerHTML = "";
					return;
				} else { 
					...
					xmlhttp.onreadystatechange = function() {
						if (this.readyState == 4 && this.status == 200) {
								...
								document.getElementById("vwbook").innerHTML = this.responseText;
							
						}
					};
					
								xmlhttp.open("GET","bookingsh.php?q="+str1,true);
								xmlhttp.send();
						...
						<div class="col-lg-12">
							  ...
							  <form action="#" id="booking" >
									<div class="btn-group btn-group-justified">
									  ...
									  <div class="btn-group">
										<input type="text" class="form-control round-form" name="issuerId" id="ism" onkeyup="ibooking(this.value)" required autofocus placeholder="Member id" onkeypress='return event.charCode >= 48 && event.charCode <= 57'><br>
									  </div>										
									</div>
									
									</form>
									
										<div class="alert alert-info" id="vwbook"><?php include("bookingData.php"); ?></div>
