...
$inputfilename = 'uploads/'.$_GET['file'];
$exceldata = array();
...
{ 
	...
	$sql = "INSERT INTO members (Id, FirstName, dept,year)
			VALUES ('".$rowData[0][0]."', '".$rowData[0][1]."', '".$rowData[0][2]."','".$rowData[0][3]."')";
	
	if (mysqli_query($db, $sql)) {
		$exceldata[] = $rowData[0];
	} else {
		echo "<div class='alert alert-danger'>Error: " . $sql . "<br>" . mysqli_error($db). "<br></div>";
	}
}

// Print excel data
echo "<div class='alert alert-success'><table class='table w3-card-2 table-bordered table-striped table-condensed'><tr><th>Id</th><th>Name</th><th>Department</th><th>Batch</th></tr>";
