...
<html lang="en">
  <head>
	...
	<script>
			...
			function addm(str) {
				var x = document.getElementById("ammyForm");
				
				if (str == "") {
					document.getElementById("amtxtHint").innerHTML = "";
					return;
				} else { 
					...
					xmlhttp.onreadystatechange = function() {
						if (this.readyState == 4 && this.status == 200) {
							document.getElementById("amtxtHint").innerHTML = this.responseText;
						}
					};
					xmlhttp.open("GET","addm.php?id="+x.elements[0].value+"&name="+x.elements[1].value+"&year="+x.elements[2].value+"&dept="+x.elements[3].value,true);
					xmlhttp.send();
				}
			}
                  	...
                  	<div class="row mtbox">
							...
							<div class="col-lg-12">
							  <div class="form-panel">
								<h1 class="major">Add-Students<br /></h1>
								<div class="addMemberForm">
									<form action="#" id="ammyForm" >
									
										<input type="text" class="form-control round-form" name="memberId" required autofocus placeholder="Member-ID" value=<?php if(!empty($lastRow)){ echo $lastRow; }?> ><br>
									
									
										<input type="text" class="form-control round-form" name="Name" required autofocus placeholder="First-Name" pattern="[A-Za-z]{3,}" title="First name must contain atleast 3 letters."><br>

									
									
										<input type="text" class="form-control round-form" name="year" required autofocus placeholder="Year" pattern="[9-0]{3,}{-}" title="Please Enter Batch "><br>
									...
									<br>
									<button onclick="addm(this.value)" class="btn btn-primary btn-lg btn-block" value="Add">Add </button>
									
								</div>
								<br>
								<div id="amtxtHint" class="alert alert-info"><b>Server Response here...</b></div>
							</div>
                      ...
                      <div class="col-md-6 mb">
							...
							<div class="white-panel pn">
								<div class="white-header">
									<h5><b>File Uploader</b></h5>
								</div>
								<div class="col-md-12 mb image_upload_div">
									<?php
										include('upindex.html');
						...
						<div class="col-md-6 mb">
							...
							<div class="white-panel pn">
								<div class="white-header">
									<h5><b>Data Inserter</b></h5>
								</div>
								<div id="load" class="col-md-12 mb alert">
