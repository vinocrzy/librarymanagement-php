...
<html lang="en">
  <head>
	...
	<script>
			function pup(str) {
				var x = document.getElementById("pupForm");
				
				if (str == "") {
					document.getElementById("pupHint").innerHTML = "";
					return;
				} 
				else { 
					...
					xmlhttp.onreadystatechange = function() {
						if (this.readyState == 4 && this.status == 200) {
							document.getElementById("pupHint").innerHTML = this.responseText;
						}
					};
					xmlhttp.open("GET","passup.php?oldpass="+x.elements[0].value+"&newpass="+x.elements[1].value,true);
					xmlhttp.send();
				}
			}
                  	...
                  	<div class="row mtbox">
						<div class="col-lg-12">
							  <div class="form-panel">
								<h1 class="major">Password Update<br /></h1>
								<div class="addMemberForm">
									<form action="#" id="pupForm" >
									...
									<br>
									<button onclick="pup(this.value)" class="btn btn-primary btn-lg btn-block" value="Change">Change </button>
									
								</div>
								<br>
								<div id="pupHint" class="alert alert-info"><b>Server Response here...</b></div>
							</div>
							</div>
                  	</div><!-- /row mt -->	
