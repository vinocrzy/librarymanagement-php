	...
	<script>
			function dam(str) {
				...
				if (str == "") {
					...
					xmlhttp.open("GET","dmg.php?bid="+x.elements[0].value,true);
					xmlhttp.send();
				}
			}
                  	...
                  	<div class="row mtbox">
							...
							<div class="col-lg-12">
							  <div class="form-panel">
								<h1 class="major">Damage Entry<br /></h1>
								<div class="addMemberForm">
									...
									<br>
									<button onclick="dam(this.value)" class="btn btn-primary btn-lg btn-block" value="Add">Add </button>
