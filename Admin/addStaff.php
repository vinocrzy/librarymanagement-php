...
$query = "Select Max(Id) From faculty";
	...
	$sq1="SELECT DISTINCT dept From faculty";
...
<link rel="stylesheet" type="text/css" href="assets/css/w3.css"> 	
	...
	<script>
			function addf(str) {
				var x = document.getElementById("afmyForm");
				
				if (str == "") {
					document.getElementById("aftxtHint").innerHTML = "";
					return;
				} else { 
					...
					xmlhttp.onreadystatechange = function() {
						if (this.readyState == 4 && this.status == 200) {
							document.getElementById("aftxtHint").innerHTML = this.responseText;
						}
					};
					xmlhttp.open("GET","addf.php?id="+x.elements[0].value+"&name="+x.elements[1].value+"&deg="+x.elements[2].value+"&dept="+x.elements[3].value,true);
					xmlhttp.send();
				}
			}
                  	...
                  	<div class="row mtbox">
							...
							<div class="col-lg-12">
							  <div class="form-panel">
								<h1 class="major">Add-Faculty<br /></h1>
								<div class="addMemberForm">
									<form action="#" id="afmyForm" >
									
										<input type="text" class="form-control round-form"  name="memberId" required autofocus placeholder="Member-ID" value=<?php if(!empty($lastRow)){ echo $lastRow; }?> readonly><br>
			
			
										<input type="text" class="form-control round-form" name="Name" required autofocus placeholder="Name" pattern="[A-Za-z]{3,}" title="First name must contain atleast 3 letters."><br>

									
										<input type="text" class="form-control round-form" name="year" required autofocus placeholder="Designation" pattern="[9-0]{3,}{-}" title="Please Enter Designation "><br>

											
										<select name="dept" id="dept" class="form-control round-form" >
									...
									<br>
									<button onclick="addf(this.value)" class="btn btn-primary btn-lg btn-block" value="Add">Add </button>
									
								</div>
								<br>
								<div id="aftxtHint" class="alert alert-info"><b>Server Response here...</b></div>
							</div>
