...
$sql = "Select * From members Where ID = $user_checkm";
$query = mysqli_query($db,$sql);
$uname = mysqli_fetch_array($query);

$query1 = "SELECT * From borrow Where issueId = '$user_checkm'";
                ...
                <div class="row">
					<div class="col-md-4">
                        <div class="card card-user">
                            <div class="image">
                                <img src="assets/img/faces/sidebar-2.jpg" alt="..."/>
                            </div>
                            <div class="content">
                                <div class="author">
                                     <a href="#">
                                    <img class="avatar border-gray" src="assets/img/faces/face-0.jpg" alt="..."/>
                                      ...
                                      <h4 class="title"><?php echo ucfirst($uname['FirstName']); ?><br />
                                         <small><?php echo $user_checkm; ?></small>
                                      </h4>
                                    </a>
                                </div>
                                <p class="description text-center"> "<?php echo ucfirst($uname['dept']); ?> "<br>
                                </p>
                            </div>
                            <hr>
								...
								<table class="table w3-card-2">
									...
									<?php
										while($result2 = mysqli_fetch_assoc($return2)){
											$bid=$result2['bookId'];
											$sqlb="Select * From books WHERE bookId = $bid";
											$resultb = mysqli_query($db,$sqlb);
											$bname=mysqli_fetch_assoc($resultb);
											
											?>
											<tr>
												<td>
													<?php echo $bname['title']; ?> </a>
												</td>
