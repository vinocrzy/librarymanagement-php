...
if($_SERVER["REQUEST_METHOD"] == "POST") 
   {
		...
		$sql = "select id from members where Id='$user_checkm' and pass='$oldpass'";
		...
		if(!empty($oldpass) && !empty($newpass) ){
			...
			if($count){
				$query = "UPDATE `members` SET `pass`='$newpass' WHERE Id='$user_checkm' and pass='$oldpass'";
